...
age(mima,53).
female(mima).
personal_anamnesis(mirko,[abusing_alchohol]).
age(mirko,23).
male(mirko).

personal_anamnesis(maska,[abusing_alchohol]).
age(maska,12).
male(maska).
personal_anamnesis(masks,[abusing_alchohol]).
age(masks,45).
female(masks).
personal_anamnesis(mirka,[abusing_alchohol, active_smoking]).
age(mirka,32).
female(mirka).
